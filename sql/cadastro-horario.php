...
if (isset($_SESSION['usuario'])) {
  ...
  $sql = "INSERT INTO tb_marcar_horario (data, turno, observacao, tattoo, usuario, caminho_tattoo, origem_formulario)
          VALUES ('$data', '$turno', '$observacao', '$target_file', '$usuario', '$caminho_tattoo' , '$origem_formulario')";
...
//   // Adicione este trecho para exibir a mensagem de cadastro
//   var mensagemCadastro = document.getElementById("Usuario cadastrado com sucesso");
//   mensagemCadastro.innerText = "";
//   if (xhr.responseText !== "") {
//     mensagemCadastro.innerText = xhr.responseText;
//   }
